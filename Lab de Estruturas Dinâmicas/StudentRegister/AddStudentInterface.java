...
{//nova frame
	...
	{//evento listener pra quando se clica botões
	...
	{//verificação de dados por regex
	...
	{//load no arquivo salvo de estudantes
		...
		Students temp = new Students(
			studentFields[0].getText(), 
			studentFields[1].getText(), 
			registrationDate, 
			studentFields[3].getText(), 
			studentFields[4].getText(), 
			studentFields[5].getText(), 
