...
public class JanelaCarrosDisponiveis extends JanelaMest {
    ...
    private CarrosDisponiveisDAO carAO = new CarrosDisponiveisDAO();

    private ClienteFiltro filtro = new ClienteFiltro();

    public JanelaCarrosDisponiveis() {
        initComponents();
        listaConcessionaria();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Concessionaria:");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(campoCarro, javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(campoQntd, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel5.setText("CONTROLE DE CARROS DISPONÍVEIS");
    ...
    public void inserirEncomenda() {
        int i = Integer.parseInt(campoQntd.getText());

        CarrosDisponiveis car = new CarrosDisponiveis();
        car.setIdCarro(idCarro);
        car.setIdConcessionaria(idConcessionaria);
        while (i > 0) {
            carAO.inserir(car);
            i--;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JanelaCarrosDisponiveis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JanelaCarrosDisponiveis().setVisible(true);
            }
        });
    }
