...
public class telaIdentificacao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(0, 233, 255));

        jLabel1.setText("INFORME SEU NOME DE USUÁRIO :");

        botaoEntrar.setFont(new java.awt.Font("Ubuntu", 1, 15)); // NOI18N
    ...
    private void botaoEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoEntrarActionPerformed
       String nome = cmpNome.getText();
        EventQueue.invokeLater(new Runnable(){
           @Override
           public void run() {
               new telaCliente(nome).setVisible(true);
           }
        });
        this.dispose();
